...
if (isset($_POST["cari"])) {
    ...
    $berita = query("SELECT * FROM berita WHERE judul LIKE '%$keyword%' OR preview LIKE '%$keyword%' OR content LIKE '%$keyword%'");
}
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 35%;">Isi</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <img class="w-75 rounded" src="../../media/berita/<?= $row["thumbnail"]; ?>" alt="tidak ditemukan">
                                        </td>
                                        <td><?= $row["judul"]; ?></td>
                                        <td><?= $row["preview"]; ?></td>
                                        <td><?= $row["content"]; ?></td>
                                        <td class="text-center align-middle">
                                            <a href="ubahBerita.php?id=<?= $row["id"]; ?>" class="btn btn-warning m-1">Edit</a>
                                            <a href="hapusBerita.php?id=<?= $row["id"]; ?>" class="btn btn-danger m-1" onclick="
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="6" class="form-control" placeholder="Tulis isi berita" name="content" id="content" required></textarea>
                                    </div>
                                    <div class="mb-3">
